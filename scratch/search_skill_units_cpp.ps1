...
Select-String -Path "skill.cpp" -Pattern "UNT_FREEZING|UNT_LANDMINE|UNT_SKIDTRAP|UNT_FLAMERUBBER|skill_unit_setting" -Context 2,5 | Select-Object -First 30 | ForEach-Object {
