...
$preReFile = "d:\SERVER_RO\LevitationRO\rathena\npc\pre-re\mobs\dungeons\prt_maze.txt"
$reFile = "d:\SERVER_RO\LevitationRO\rathena\npc\re\mobs\dungeons\prt_maze.txt"
...
//= Custom: Fixed coordinate spawns without minibosses (Baphomet MVP included)
//============================================================
...
[System.IO.File]::WriteAllText($preReFile, $content, $utf8NoBom)
[System.IO.File]::WriteAllText($reFile, $content, $utf8NoBom)
Write-Host "Restored Baphomet MVP into prt_maze.txt spawn files!"
