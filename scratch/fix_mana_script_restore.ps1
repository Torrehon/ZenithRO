...
$manaContent = '// ==========================================================
// Sistema de Ciclo Ambiental Dinamico y Mana Engine
// Estados Globales: Dia (0), Noche (1), Lluvia de Estrellas (2)
// ==========================================================
...
// ==========================================================
// Gatillo Automatico (Cada 3 horas)
// ==========================================================
...
L_TriggerCycle: 
	...
	if (.@roll <= $StarShowerChance) {
		// ==============================================
		// EXITO! LLUVIA DE ESTRELLAS (Estado 2)
		// ==============================================
		...
		// MANA ENGINE: Calculo Aleatorio 6.00x - 8.00x
		...
		// Aplicacion directa y nativa de rates con recarga integrada (, true)
		...
		// ==============================================
		// FALLO: CICLO NORMAL (Dia / Noche)
		// ==============================================
		set $StarShowerChance, $StarShowerChance + 10;
		
		// Restablecemos clima de hojas y rates base si veniamos de una lluvia activa
		callsub L_RemoveLeaves;
...
Write-Host "Fully restored npc/custom/mana.txt with all global variables!"
