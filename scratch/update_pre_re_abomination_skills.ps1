...
$skillLines = @(
    ...
    "3484,Abomination of Souls@NPC_SUMMONSLAVE,idle,196,4,10000,0,0,no,self,onspawn,0,1857,,,,,,",
    "3484,Abomination of Souls@NPC_SUMMONSLAVE,attack,196,4,5000,1000,15000,no,self,slavele,1,1857,,,,,,",
    "3484,Abomination of Souls@NPC_SUMMONSLAVE,idle,196,4,5000,1000,15000,no,self,slavele,1,1857,,,,,,",
