...
// --- NUEVA DATABASE PARA BALAS ---
class SkillBulletDatabase : public TypesafeYamlDatabase<t_itemid, s_skill_arrow_db> {
public:
	SkillBulletDatabase() : TypesafeYamlDatabase("CREATE_BULLET_DB", 1) {
...
extern SkillArrowDatabase skill_arrow_db;
extern SkillBulletDatabase skill_bullet_db; // <-- Añadido
...
enum e_skill {
	...
	HT_SHOOTERSOUL = 1045,
	HT_TRAPPERSOUL = 1046,
	BS_JUGGERNAUTSOUL = 1047,
	BS_FORGEMASTERSOUL = 1048,
	PR_EXORCISTSOUL = 1049,
	PR_SAINTSOUL = 1050,
	AS_EXECSOUL = 1051,
	AS_VIPERSOUL = 1052,
	CR_TEMPLARSOUL = 1053,
	CR_GUARDIANSOUL = 1054,
	NJ_KENSEISOUL = 1055,
	NJ_KUJISOUL = 1056,
	SA_ARCSOUL = 1057,
	SA_LORESOUL = 1058,
