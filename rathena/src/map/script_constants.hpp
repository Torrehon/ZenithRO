...
#define SCRIPT_CONSTANTS_HPP
	...
	//CUSTOM JOBS
	export_constant(JOB_GENIN);
    export_constant(JOB_HIREGUN);
	...
	//CUSTOM JOBS EA2
    export_constant2("EAJ_GENIN",MAPID_GENIN);
    export_constant2("EAJ_HIREGUN",MAPID_HIREGUN);
	...
	export_constant(SC_NJ_COMBO);
	export_constant(SC_LIGHTFINGERS);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(EFST_NJ_COMBO);
	export_constant(EFST_LIGHTFINGERS);
	export_constant(EFST_MOMENTUM);
	export_constant(EFST_EXPOSED);
