macro( INSTALL_TEMPLATE _SRC _DST )
  set( SRC "D:/SERVER_RO/LevitationRO/rathena/${_SRC}" )
  set( DST "${CMAKE_INSTALL_PREFIX}/${_DST}" )
  if( EXISTS "${DST}" )
    message( "-- Already exists: ${DST}" )
  else()
    message( "-- Installing template: ${DST}" )
    execute_process( COMMAND "D:/SERVER_RO/VSCommunity/Common7/IDE/CommonExtensions/Microsoft/CMake/CMake/bin/cmake.exe" -E copy "${SRC}" "${DST}" )
  endif()
endmacro()
